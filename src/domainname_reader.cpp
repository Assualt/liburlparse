...
namespace {
int MAX_TOP_LEVEL_DOMAIN = 22;
int MIN_TOP_LEVEL_DOMAIN = 2;
long MAX_NUMERIC_DOMAIN_VALUE = 4294967295L;
long MIN_NUMERIC_DOMAIN_VALUE = 16843008L;
int MIN_IP_PART = 0;
int MAX_IP_PART = 255;
int INTERNATIONAL_CHAR_START = 192;
int MAX_LABEL_LENGTH = 64;
int MAX_NUMBER_LABELS = 127;
int MAX_DOMAIN_LENGTH = 255;
std::string HEX_ENCODED_DOT = "2e";
}  // namespace
