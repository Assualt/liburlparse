 ...
 */
constexpr int MINIMUM_BACKTRACK_LENGTH = 20;

/**
 * When detecting for exceeding the backtrack limit, make sure the text is
 * at least 20 characters.
 */
constexpr int MAX_BACKTRACK_MULTIPLIER = 10;
}
...
void InputTextReader::seek(int position) {
    int backtrackLength = std::max(_index - position, 0);
