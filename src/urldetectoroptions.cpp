...
UrlDetectorOptions UrlDetectorOptions_T::get(int index) {
	...
	case 1: return QUOTE_MATCH;
	case 2: return SINGLE_QUOTE_MATCH;
	case 4: return BRACKET_MATCH;
	case 5: return JSON;
	case 7: return JAVASCRIPT;
	case 9: return XML;
	case 27: return HTML;
	case 32: return ALLOW_SINGLE_LEVEL_DOMAIN;
	default:
		return Default;
	}
}
int UrlDetectorOptions_T::getValue(UrlDetectorOptions flag) {
	...
	case QUOTE_MATCH:value = 1; break;
	case SINGLE_QUOTE_MATCH:value = 2; break;
	case BRACKET_MATCH:value = 4; break;
	case JSON:value = 5; break;
	case JAVASCRIPT:value = 7; break;
	case XML:value = 9; break;
	case HTML:value = 27; break;
	case ALLOW_SINGLE_LEVEL_DOMAIN:value = 32; break;
